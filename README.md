...
> 这是一套完整的网文写作辅助指令，覆盖从构思到成稿的全流程。我个人主要用于Droid中使用，也可以迁移到claude code和opencode，不过需要做一些参数的调整。

## 命令总览

![命令总览](images/commands_chalkboard_1770781448_0.png)

## 个人自用流程图

![小说一般流程](images/小说一般流程.png)
